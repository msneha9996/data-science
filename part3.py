...
diabetes = pd.read_csv('E:/Final Year/Data Science/training.csv', na_values=['NA'])
X = diabetes.iloc[:,:-1]
y = diabetes.iloc[:,-1:]
...
nn = NeuralNetMLP(n_output=10, n_features=X_train.shape[1],n_hidden=100,l2=0.1,l1=0.0,epochs=1000,eta=0.1,alpha=0.1,decrease_const=0.00001,shuffle=True,minibatches=50,random_state=1)
